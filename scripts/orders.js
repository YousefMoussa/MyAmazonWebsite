...
if(orders != null){
  orders.forEach((order) => {
      ...
      const orderPlaced  = orderDate.format('dddd, MMMM D');
      const orderCost = formatCurrency(order.totalCostCents);
      ...
      order.products.forEach((productInfo) => {
          ...
          let product  = getProduct(productInfo.productId);
          orderProductsHTML +=`
          ...
          <div class="product-details">
              ...
              <button data-quantity="${productInfo.quantity}" data-product="${productInfo.productId}" class="buy-again-button button-primary">
          ...
          <div class="product-actions">
              <a href="tracking.html?orderId=${orderId}&productId=${productInfo.productId}">
...
function addToCartQuantity(productId, quantity){
    ...
    document.querySelectorAll('.buy-again-button').forEach((button) => {
        button.addEventListener('click',() => {
            addToCartQuantity(button.dataset.product, button.dataset.quantity);
